...
static inline void hwpe_in1_0_addr_set(int32_t value) {
  HWPE_WRITE(value, HWPE_IN1_0_ADDR);
}

static inline void hwpe_in2_0_addr_set(int32_t value) {
  HWPE_WRITE(value, HWPE_IN2_0_ADDR);
}

static inline void hwpe_out_r_addr_set(int32_t value) {
  HWPE_WRITE(value, HWPE_OUT_R_ADDR);
}
...
// }
// custom hal
// static inline void hwpe_dumb_set(int32_t value) {
//   HWPE_WRITE(value, HWPE_DUMB );
// }
...
static inline void hwpe_addr_gen_in1(
  ...
  unsigned int step)
{
  HWPE_WRITE(port_offset,   HWPE_IN1_PORT_OFFSET );
...
static inline void hwpe_addr_gen_in2(
  ...
  unsigned int step)
{
  HWPE_WRITE(port_offset,   HWPE_IN2_PORT_OFFSET );
