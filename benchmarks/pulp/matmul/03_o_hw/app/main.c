  ...
  uint32_t width, uint32_t height, uint32_t stripe_height, uint32_t clk_counter[10])
{
  if (hero_rt_core_id() == 0){
    ...
    addr_gen_in1.trans_size    = width * stripe_height * stripe_height;
    addr_gen_in1.line_stride   = 0;
    addr_gen_in1.line_length   = width;
    ...
    addr_gen_in2.trans_size    = width * stripe_height * stripe_height;
    addr_gen_in2.line_stride   = width * sizeof(uint32_t);
    addr_gen_in2.line_length   = width;
