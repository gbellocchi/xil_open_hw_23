      ...
      loop_B: for(int jj = stripe_height; jj < height; jj += stripe_height){
        ...
        if(!sel_in2){
          ...
          if(!sel_in1){
            ...
            comp = compute(l1_buffer1_in1, l1_buffer1_in2, l1_buffer1_out + l1_buffer_out_offset, width, stripe_height); 
            ...
            comp = compute(l1_buffer0_in1, l1_buffer1_in2, l1_buffer0_out + l1_buffer_out_offset, width, stripe_height); 
          ...
          if(!sel_in1){
            ...
            comp = compute(l1_buffer1_in1, l1_buffer0_in2, l1_buffer1_out + l1_buffer_out_offset, width, stripe_height); 
            ...
            comp = compute(l1_buffer0_in1, l1_buffer0_in2, l1_buffer0_out + l1_buffer_out_offset, width, stripe_height); 
